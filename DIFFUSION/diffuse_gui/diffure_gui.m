...
% Last Modified by GUIDE v2.5 15-Sep-2013 14:45:04
...
if ~isnan(str2double(stringValue))
    ...
    if (textValue > 9 && textValue < handles.maxN + 1)
       ...
       set(handles.edit3, 'String', handles.X +.5);       
...
handles.C(1,:,1) = 0;
handles.C(handles.numX,:,1)= 0;

handles.C(:,1,1) = 0;
handles.C(:,handles.numY,1)= 0;


if ~handles.radio;
    for i = 2:handles.numX-1
        for j = 2:handles.numY-1
            handles.C(i,j,1) = handles.T*( (((i-handles.X)/handles.R)^2 ... 
